...
-- Re-running is safe: users/goals use ON CONFLICT DO NOTHING,
-- entries are deleted and re-inserted for the seeded date range.
-- ============================================================
...
-- ============================================================
-- Historical entries — clear range before re-seeding
-- ============================================================
DELETE FROM entries WHERE date BETWEEN '2026-04-07' AND '2026-04-15';
